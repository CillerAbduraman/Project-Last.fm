                ...
                <tr>
                    ...
                    <td>
                        <div style={container}>
                            ...
                            <input type="text" name="ascultatori" value={item.listeners} style={hidden} />
                            <input type="text" name="nume" value={item.name} style={hidden} />
                            <input type="submit" value="Add to favorite artists" />
                        </div>
                      </td>
                    </form>
                </tr>
